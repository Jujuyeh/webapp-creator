...
void insertQML (char name[], char maint[]){
	...
	"}";
	f.close();
	f.open("../webappData/qml/ContentPickerDialog.qml");
	f  << "/*\n"
	...
	"}";
	f.close();
	f.open("../webappData/qml/MimeTypeMapper.js");
	f << "/*\n"
	" * Copyright 2014 Canonical Ltd.\n"
	" *\n"
	" * This file is part of webbrowser-app.\n"
	...
	"}";
	f.close();
	f.open("../webappData/qml/ThinProgressBar.qml");
	f << "/*\n"
	" * Copyright 2014 Canonical Ltd.\n"
	" *\n"
	" * This file is part of webbrowser-app.\n"
	...
	"}";
	f.close();
	f.open("../webappData/qml/UCSComponents/EmptyState.qml");
	...
	"}";
	f.close();
	f.open("../webappData/qml/UCSComponents/RadialAction.qml");
	f << "import QtQuick 2.0\n"
	"import Ubuntu.Components 1.1\n"
	"\n"
	"Action {\n"
	...
	"}";
	f.close();
	f.open("../webappData/qml/UCSComponents/RadialBottomEdge.qml");
	f << "import QtQuick 2.0\n"
	"import QtFeedback 5.0\n"
	"import Ubuntu.Components 1.1\n"
